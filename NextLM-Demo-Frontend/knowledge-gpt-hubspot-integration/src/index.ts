...
export default integration({
  name: "NextLM HubSpot Integration",
  description: "Push AI-powered candidate search results with behavioral analytics to HubSpot CRM (App ID: 15225474)",
  category: "CRM",
  labels: ["crm", "hubspot", "ai", "behavioral-analytics", "oauth"],
  iconPath: "icon.png",
  version: "1.0.1",
  flows,
  configPages,
